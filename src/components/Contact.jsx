  ...
  async function handleSubmit(event) {
    ...
    try {
      const res = await fetch(
        "https://formsubmit.co/ajax/sguptagzp200@gmail.com",
        {
          method: "POST",
          headers: {
      ...
      <div className="section-container">
        ...
        <div className="contact-content">
          <div className="contact-info">
            <div>
              <strong>Email</strong>
              <a href="mailto:sguptagzp200@gmail.com">
                sguptagzp200@gmail.com
              </a>
            </div>
            ...
            <div>
              ...
              <a
                ...
                rel="noreferrer"
              >
                linkedin.com/in/santosh-gupta-8285a738b
              </a>
            </div>
          </div>
